...
class Patient(ABC):
    ...
    @property
    def days_in_hospital(self) -> Union[int, str]:
    ...
    def diagnosis(self, new_diagnosis: str) -> None:
        ...
        old_diagnosis: str = self.__diagnosis
    ...
    def doctor_specialization(self, new_specialization: str) -> None:
        ...
        old_spec: str = self.__doctor_specialization
    ...
    def temperature(self, new_temperature: float) -> None:
        ...
        old_temp: float = self.__temperature
    ...
    def update_vitals(
        ...
        if systolic is not None or diastolic is not None:
            new_systolic: int = systolic if systolic is not None else self.__systolic
            new_diastolic: int = diastolic if diastolic is not None else self.__diastolic
